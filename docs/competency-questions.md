...
| C6 | This bout is tagged with a matriline. Which pod and ecotype does that roll up to? | SalishSea.io ingest | Yes — `ancestor.tsv`, all the way to the species. The ecotype level arrived with [Q1](open-questions.md#q1--is-southern-resident-an-ecotype-or-a-community-of-the-resident-ecotype); before it, twelve entities rolled up to nothing |
